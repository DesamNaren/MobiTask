...
//
//import com.example.mainactivity.source.ParseResult;
//import com.example.mainactivity.source.TaskOutput;
//import com.example.mainactivity.source.TaskResult;
...
//    Context context;
//    MainWeatherActivity activity;
//    public int loading = 0;
//
//    public GenericRequestTask(Context context, MainWeatherActivity activity, ProgressDialog progressDialog) {
...
//        String apiKey = sp.getString("apiKey", BuildConfig.APP_ID);
//
...
//        } else {
//            final String city = sp.getString("city", AppConstants.DEFAULT_CITY);
