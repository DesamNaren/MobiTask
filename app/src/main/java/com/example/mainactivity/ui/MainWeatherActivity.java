...
//        //WEATHER_VALUE
//        progressDialog = new ProgressDialog(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this);
//
...
//        todayTemperature.setText("" + intent.getStringExtra("WEATHER_VALUE"));
//
...
//            try {
//                locationManager.removeUpdates(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this);
...
//        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this);
//
...
//                    Toast.makeText(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this, "Please enter your city", Toast.LENGTH_SHORT).show();
//                }
//                else {
//                    if (!result.isEmpty()) {
//                        saveLocation(result);
...
//        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this);
...
//
//            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this).edit();
...
//        try {
//
//            temperature = UnitConvertor.convertTemperature(Float.parseFloat(todayWeather.getTemperature()), sp);
...
//        double pressure = 0;
//        try {
//            pressure = UnitConvertor.convertPressure((float) Double.parseDouble(todayWeather.getPressure()), sp);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
...
//
//        public TodayWeatherTask(Context context, cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity activity, ProgressDialog progressDialog) {
...
//            // Update widgets
//            //AbstractWidgetProvider.updateWidgets(MainWeatherActivity.this);
//            //DashClockWeatherExtension.updateDashClock(MainWeatherActivity.this);
//        }
//
//        @Override
...
//        public LongTermWeatherTask(Context context, cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity activity, ProgressDialog progressDialog) {
//            super(context, activity, progressDialog);
//        }
//
//        @Override
...
//
//        public ProvideCityNameTask(Context context, cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity activity, ProgressDialog progressDialog) {
//            super(context, activity, progressDialog);
//        }
//
//        @Override
...
//        // super.onBackPressed();
//        Intent intent=new Intent(cgg.gov.ghmc.ui.weatherapi.activities.MainWeatherActivity.this, DashBoardActivity.class);
